  ...
  return (
    <div className="modal-overlay">
      <div id="logs-window">
        ...
        <div style={{color: 'var(--bg-main)', display: 'flex', justifyContent: 'center'}}>Big Brother is watching you</div>
        ...
        <svg className='close-button close-logs' onClick={props.logWindowClose} width="800px" height="800px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M5.293 5.293a1 1 0 0 1 1.414 0L12 10.586l5.293-5.293a1 1 0 1 1 1.414 1.414L13.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414L12 13.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L10.586 12 5.293 6.707a1 1 0 0 1 0-1.414z" /></svg>
      </div>
    </div>
  )
}
