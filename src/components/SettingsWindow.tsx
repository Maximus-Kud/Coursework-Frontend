...
function SettingsWindow (props: Props) {
  ...
  return (
    <div id='settings-page'>
      <div id='settings-possibilities'>
        <div id='option-theme' onClick={() => setCurrentSettingsSection(SettingsSections.Theme)} style={{color: 'var(--text-main)'}}>{SettingsSections.Theme}</div>
      </div>

      <div id='settings-sections'>
        {currentSettingsSection === SettingsSections.Theme ? (
          <div id='possible-themes'>
            <div className='theme-option' onClick={() => props.setActiveTheme(Themes.Light)}>
              <svg className='theme-icon' width="800px" height="800px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='theme-option-text' style={{color: 'var(--text-main)'}}>{Themes.Light}</div>
            </div>

            <div className='theme-option' onClick={() => props.setActiveTheme(Themes.Dark)}>
              <svg className='theme-icon' width="800px" height="800px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className='theme-option-text' style={{color: 'var(--text-main)'}}>{Themes.Dark}</div>
            </div>
          </div>
        ) : <div style={{fontFamily: 'Google-Sans-Bold', fontSize: '25px', color: 'var(--text-main)'}}>Choose a section</div>}
      </div>

      <svg className='close-button' onClick={props.settingsClose} width="800px" height="800px" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M5.293 5.293a1 1 0 0 1 1.414 0L12 10.586l5.293-5.293a1 1 0 1 1 1.414 1.414L13.414 12l5.293 5.293a1 1 0 0 1-1.414 1.414L12 13.414l-5.293 5.293a1 1 0 0 1-1.414-1.414L10.586 12 5.293 6.707a1 1 0 0 1 0-1.414z" /></svg>
    </div>
  )
}
