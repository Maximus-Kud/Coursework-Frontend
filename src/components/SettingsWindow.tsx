  ...
  return (
    <div id='settings-page'>
      <div id='settings-possibilities'>
        <div id='option-theme' onClick={() => setCurrentSettingsSection(SettingsSections.Theme)}>{SettingsSections.Theme}</div>
      </div>
        ...
        {currentSettingsSection === SettingsSections.Theme ? (
          <div id='possible-themes'>
            <div className='theme-option' onClick={() => props.setActiveTheme(Themes.Light)}>
              ...
              <div className='theme-option-text'>{Themes.Light}</div>
            </div>
            ...
            <div className='theme-option' onClick={() => props.setActiveTheme(Themes.Dark)}>
              ...
              <div className='theme-option-text'>{Themes.Dark}</div>
            </div>
          </div>
