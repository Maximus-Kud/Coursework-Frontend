  ...
  return (
    <div className="modal-overlay">
      <div id="account-info">
        ...
        <svg className='close-button' onClick={onClose} width="30px" height="30px" viewBox="0 0 24 24" fill="currentColor" style={{ position: 'absolute', top: '20px', right: '20px', cursor: 'pointer' }}>
